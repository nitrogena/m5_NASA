...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener {
    ...
    public void onConnected(@Nullable Bundle bundle) {
        //GOOGLE VA A SUS SERVIDORES Y REVISA SI ESTA CONFIGURADO EL API KEY, Y GOOGLE PLAY SERVICES
        //showCurrentLocation(LocationServices.FusedLocationApi.getLastLocation(mGoogleApiClient));
        //lo de arriba causa mucha generacion de cosas, por eso se hace otra cosa mas rapida
